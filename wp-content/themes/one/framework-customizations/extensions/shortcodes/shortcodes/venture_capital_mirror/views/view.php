...
<div data-animated="<?=$animated?>"
     class="animated venture_capital_mirror js_mobile_margin <?=$class?>"
     data-m-top="<?=$m_margin_top?>"
     data-m-bottom="<?=$m_margin_bottom?>"
     style="margin-top: <?=$margin_top?>;
     margin-bottom: <?=$margin_bottom?>;">
  <div class="venture_capital_mirror__block <?=$background_mobile?>" style="background-image:url(<?=$background?>);">
    <div class="venture_capital_mirror__title">
      <?=$atts['title']?>
    </div>
    <div class="venture_capital_mirror__block2">
      <div class="venture_capital_mirror__left">
        <div class="venture_capital_mirror__black_block"></div>
        <div class="venture_capital_mirror__content_1">
          <?=$atts['content_1']?>
        </div>
        <div class="venture_capital_mirror__content_2">
          <?=$atts['content_2']?>
        </div>
      </div>
      <div class="venture_capital_mirror__right">
        <img class="venture_capital_mirror__image" src="<?=$image?>"/>
      </div>
    </div>
  </div>
</div>
